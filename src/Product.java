public class Product {
    ...
    private String name;
    private double price;  // Price in KZT
    ...
    public void applyDiscount(double percentage) {
        if (percentage >= 0 && percentage <= 100) {
            ...
            System.out.println("Applied " + percentage + "% discount to " + name + ". New price: " + this.price + " KZT");
        } else {
    ...
    public void restock(int quantity) {
        ...
        System.out.println("Restocked " + quantity + " units of " + this.name + ". Product is now available.");
    }
    ...
    public String toString() {
        return String.format("Product[name='%s', price=%.2f KZT, category='%s', available=%s]",
